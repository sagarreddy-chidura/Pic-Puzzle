...
super("Pic Puzzle by Sagar Reddy");
...
JLabel l2=new JLabel("NOTE:: You can swap with neighbour icon using this icon ");
l2.setBounds(5,15,500,20);
JLabel l3=new JLabel("click sample pic to get next puzzle.");
